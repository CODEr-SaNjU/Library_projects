# Generated by Django 3.2.3 on 2021-05-17 16:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Book_Author', models.CharField(max_length=200, verbose_name='Author Name ')),
                ('Book_Isbn', models.CharField(max_length=50, unique=True, verbose_name='Book ISBN Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Book_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.bookauthor', verbose_name='Book Info')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
